...
(function (global) {
  ...
  const ICON_PATHS = {
    ...
    whatsapp: '<path d="M12 2a10 10 0 0 0-8.6 15.1L2 22l5.06-1.33A10 10 0 1 0 12 2z"/><path d="M8.5 8.4c.2-.5.4-.5.6-.5h.5c.16 0 .35 0 .5.4.2.5.6 1.5.65 1.6.05.15.08.3 0 .5-.08.15-.13.25-.25.4-.13.15-.27.32-.38.43-.13.13-.26.27-.11.53.15.26.65 1.08 1.4 1.75.97.86 1.78 1.13 2.04 1.26.26.13.4.1.55-.06.15-.17.63-.73.8-.98.17-.25.34-.2.56-.12.23.08 1.44.68 1.68.8.24.13.4.2.46.3.06.13.06.7-.17 1.36-.23.67-1.32 1.28-1.83 1.36-.47.08-1.05.1-1.7-.1-.4-.13-.9-.3-1.56-.58-2.74-1.18-4.53-3.94-4.67-4.12-.13-.18-1.1-1.46-1.1-2.79 0-1.32.68-1.97.93-2.24z" fill="currentColor" stroke="none"/>',
